...
### v1.0 — 2026-05-23
첫 정식 버전입니다. 모바일 사용성과 디테일 마감을 끝내고, 저장소를 외부 공개에 맞게 정리했습니다. 이 시점부터 라이브러리는 누구나 클론해 바로 쓸 수 있는 상태가 됐습니다.

### v0.5 — 2026-05-18 ~ 2026-05-19
모바일 추천 영역을 가로 스크롤 카루셀로 전환하고, 인덱스 페이지의 깨진 링크와 누락된 템플릿을 정리했습니다. 사용자가 실제로 둘러보는 흐름을 매끄럽게 만든 라운드입니다.

### v0.4 — 2026-05-16
warm-cream 템플릿을 AI ROASTING 브랜드로 통일하고 한국어 카피를 실제 서울 화법으로 다시 썼습니다. tri-color-magazine에는 호스트 색과 슬라이드 색의 동기화 트랜지션을 넣어 매거진 톤 템플릿의 완성도를 끌어올렸습니다.

### v0.3 — 2026-05-14 ~ 2026-05-15
산출물 기본 형식을 HTML에서 PPTX로 바꾸고, 기존 슬라이드를 분석해 시스템 프롬프트로 역추출하는 `slide-clone` 스킬을 추가했습니다. 인덱스 페이지는 레트로 카세트 톤으로 리디자인했고, 사이트 제목을 `AI ROASTING · Slide Library`로 정식화했습니다. 라이브러리가 단순 갤러리에서 생성 도구로 확장된 단계입니다.

### v0.2 — 2026-05-10 ~ 2026-05-11
전체 템플릿에 `prompt.md`를 부착해 각 템플릿이 그 자체로 재사용 가능한 자산이 되도록 만들었습니다. 히어로 영역을 3-up coverflow 캐러셀로 재설계하고, README와 가이드 톤을 입니다체로 통일했습니다.

### v0.1 — 2026-05-09 (최초 공개)
슬라이드 라이브러리를 처음 공개했습니다. 템플릿, 스크린샷, 런타임 셋업과 OG 메타까지 묶어 외부에서 접근 가능한 형태로 출발했습니다.
