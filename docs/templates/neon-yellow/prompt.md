...
- consult col meta: 32px 700 line-height 1.1. 주요 수치 한 줄. 예: "$4.1M 예상 유지 ARR, 현재 코호트 기준". 라벨이므로 명사구로 끝낸다.
...
**이 템플릿에만 적용되는 예외**
- (규칙 1) 컬럼 `.meta`는 수치 한 줄을 강조하는 라벨이므로 명사구로 끝낸다. §4.3·§4.9의 예시는 `$4.1M 예상 유지 ARR, 현재 코호트 기준`으로 쓴다.
...
<section class="slide s-consult" data-label="09 Findings · Detail">
  <div class="frame">
    ...
    <div class="col b">
      <h3>중요한 이유</h3>
      <div class="col-body">
        <div class="meta">$4.1M 예상 유지 ARR, 현재 코호트 기준</div>
